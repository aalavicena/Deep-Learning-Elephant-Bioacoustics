...
# 
# subscription_id = '39ed7c04-d4a0-44fe-8f7a-bc75f5456483'
# resource_group = 'Model1'
# workspace_name = 'Model1'
# 
# workspace = Workspace(subscription_id, resource_group, workspace_name)
# 
# dataset = Dataset.get_by_name(workspace, name='FYP_EleBio')
# dataset.download(target_path='/mnt/batch/tasks/shared/LS_root/mounts/clusters/hgyna1/code/Users/hgyna1/data', overwrite=True)

# This code was adapted from several repositories:
# 
...
# 3. https://medium.com/dataseries/k-fold-cross-validation-with-pytorch-and-sklearn-d094aa00105f (K-Fold Cross Validation) Not yet implemented
...
train['relative_path'] = '/' + train['datasetid'].astype(str) + '/' + train['itemid'].astype(str)
test['relative_path'] = '/' + test['datasetid'].astype(str) + '/' + test['itemid'].astype(str)

# Take relevant columns
df_train = train[['relative_path', 'ele']]
df_test = test[['relative_path', 'ele']]
...
data_path = ('/mnt/batch/tasks/shared/LS_root/mounts/clusters/hgyna1/code/Users/hgyna1/data')
...
trainds = SoundDS(df_train, data_path)
...
torch.save(model.state_dict(),'/mnt/batch/tasks/shared/LS_root/mounts/clusters/hgyna1/code/Users/hgyna1/Results_revised/CNN1.pt')
...
#------------------------
# Inference (RUN BLOCK 3, 4, 7 PRIOR TO DOING INFERENCE)
#------------------------
...
model = AudioClassifier()
model.load_state_dict(torch.load('/mnt/batch/tasks/shared/LS_root/mounts/clusters/hgyna1/code/Users/hgyna1/Results_revised/CNN1.pt'))
model.eval()
...
# Read metadata file
os.chdir('/mnt/batch/tasks/shared/LS_root/mounts/clusters/hgyna1/code/Users/hgyna1/data')
df = pd.read_csv('MEME_DS_updated.csv')
df.head()
